...
def run_login_test(request: TestRunRequest, shared_manager: WebDriverManager | None = None) -> TestCaseResult:
    """执行登录流程自动化测试
    ...
    Args:
        ...
        shared_manager: 可选的共享浏览器实例，为 None 时自动创建
    ...
    try:
        ...
        try:
            ...
            if alt_btn:
                ...
                selenium_logs.append("[ERROR] NoSuchElementException: 找不到登录按钮")
